...
\item the action client for the \mbox{\hyperlink{namespacego__to__point}{go\+\_\+to\+\_\+point}}
...
{\em req} & is the request received from the client of the user\+\_\+interface.\+py the field command in the srv file \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
a boolean value
